...
parser.add_argument('--outputroot', default='./data/', type=str, help="Path to data root; expects an img folder in the root")
...
if __name__ == "__main__":
    ...
    pathXid = load_image_ids(DATA_ROOT)     # Get paths and ids
